    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section aria-labelledby="hero-heading" className="mb-8">
        ...
        <p className="max-w-2xl text-base text-muted-foreground">
          Browse, cook, and create recipes with deep accessibility support —
          voice guidance, high contrast, dyslexia-friendly mode, and more. Every
          recipe is designed to be enjoyed by everyone.
        </p>
      </section>
